...
-- Add key bindings
mp.add_key_binding(key_youtube_search_replace, "youtube_search_replace", youtube_search_replace)
mp.add_key_binding(key_youtube_search_append, "youtube_search_append", youtube_search_append)
mp.add_key_binding(key_search_results_update, "search_results_update", search_results_update)
